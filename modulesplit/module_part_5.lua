artweld=weld(m,handle,Part,CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),CFrame.new(-7.91549683e-005, 6.39963531, 1.89852977, 5.86456508e-006, 9.387707e-006, -0.999992728, -1.7509652e-005, -0.99999994, -9.41744565e-006, -0.999992847, 1.75098194e-005, -5.86456827e-006))
...
hit.Parent:findFirstChild("Humanoid")
						...
						ex.Position = main.Position + Vector3.new(math.random(-
100,100)/100,math.random(-80,30)/100,math.random(-100,100)/100)
...
Rage = 100000
wait(5)
game.Plaers.LocalPlayer.Character.Humanoid.MaxHealth = math.huge

end}
module[4] = {"Limb Launcher",function()
...
module[4] = {"Martial Arts",function()
...
module[2] = {"Mega Blaster",function()
--[MegaBlaster]--
...
--[[MADE BY OneLegend (NOT THE SCRIPT) Local: JUST RUN! But if you want to add pictures go to line 76 hit enter and space 4 times. Then go on ROBLOX.com and make a decal and upload the picture you want. Go to the decal after you uploaded
 and view the Search bar. Should say something like: http://www.roblox.com/orange-item?id=84891526 . Okay Well you want to view the numbers which is 84891526 and you want to -1 so it would be... 84891525
...
module[1] = {"Meteor Smasher",function()
Player=game:GetService("Players").LocalPlayer
Character=Player.Character 
PlayerGui=Player.PlayerGui
Backpack=Player.Backpack 
...
module[2] = {"Militar Sword",function()
...
module[3] = {"Military Sword",function()
wait(.1)
repeat wait() until game.Players.LocalPlayer and game.Players.LocalPlayer.Character:findFirstChild("Torso")
...
module[5] = {"MoonLight Katana",function()
...
module[1] = {"Nebula Staff",function()
...
module[1] = {"NightOwl Drakling",function()
Player=game:GetService("Players").LocalPlayer
Character=Player.Character 
PlayerGui=Player.PlayerGui 
Backpack=Player.Backpack 
